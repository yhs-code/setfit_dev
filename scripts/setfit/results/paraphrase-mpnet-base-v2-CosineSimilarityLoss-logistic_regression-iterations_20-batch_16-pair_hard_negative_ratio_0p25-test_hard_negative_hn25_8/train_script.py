...
# Script was called via:
#python scripts/setfit/run_fewshot.py --sample_sizes=8 --is_test_set=true --num_iterations=20 --pair_strategy hard_negative --hard_negative_ratio=0.25 --exp_name test_hard_negative_hn25_8